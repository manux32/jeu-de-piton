...
export const NOTICE_OFFSET_Y = 0.2   // how far up from the bottom of the corner the stack sits
export const NOTICE_WIDTH = 7.0       // box width, in squares (a row's text wraps at this width)
...
export const NOTICE_DIE_SIZE = 2.0    // each row's little die, as a multiple of the row's text height
