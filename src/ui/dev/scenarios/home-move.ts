...
const homeMove: DevScenario = {
  id: 'home-move',
  label: 'HOME move',
  hint: 'Red rolled 3 from lane step 4 → exact HOME: the target marker should be the larger, bolder, pulsing one.',
  build: () => {
    ...
    return {
      ...
      rolled: 3,
      notice: 'Dev: a roll of 3 finishes red-0 — the HOME target should pulse big.',
    }
  },
}
